...
% New Source
%%%%AddCircAtomicArray(3e-10, 2, 4, 10, 15, 5e-10, 200, 0);
AddParticleStream(10, -10, 0.05, 0, 2, Ep * C.q_0, 5);
AddParticleStream(10, 10, 0.15, pi, 2, Ep * C.q_0, 5);
